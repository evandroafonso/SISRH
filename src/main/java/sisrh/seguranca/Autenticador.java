...
public class Autenticador {
	...
	public static boolean autenticarUsuarioSenha(WebServiceContext context)
			throws Exception {
	...
	@SuppressWarnings("rawtypes")
	public static String getUsuario(WebServiceContext context)
			throws Exception {
		MessageContext messageContext = context.getMessageContext();
		Map httpHeaders = (Map) messageContext
				.get(MessageContext.HTTP_REQUEST_HEADERS);
	...
	private static boolean autenticarUsuarioSenha(String usuario, String senha)
			throws Exception {
		try {
